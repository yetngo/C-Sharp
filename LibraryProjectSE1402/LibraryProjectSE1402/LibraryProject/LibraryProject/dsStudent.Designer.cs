...
namespace LibraryProject {
    ...
    public partial class dsStudent : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string StudentID, string FullName, string Email, int Status, string Class) {
...
namespace LibraryProject.dsStudentTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([StudentID], [FullName], [Email], [Status], [Class])" +
                " VALUES (@StudentID, @FullName, @Email, @Status, @Class);\r\nSELECT StudentID, Ful" +
                "lName, Email, Status, Class FROM Student WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentID] = @StudentID, [FullName] = @FullName, [Email] = @Email, [Status] = @Status, [Class] = @Class WHERE (([StudentID] = @Original_StudentID) AND ([FullName] = @Original_FullName) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Class = 1 AND [Class] IS NULL) OR ([Class] = @Original_Class)));
SELECT StudentID, FullName, Email, Status, Class FROM Student WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FullName, Email, Status, Class FROM dbo.Student";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsStudent.StudentDataTable dataTable) {
        ...
        public virtual int Delete(string Original_StudentID, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_Status, string Original_Class) {
        ...
        public virtual int Insert(string StudentID, string FullName, string Email, global::System.Nullable<int> Status, string Class) {
            if ((StudentID == null)) {
        ...
        public virtual int Update(string StudentID, string FullName, string Email, global::System.Nullable<int> Status, string Class, string Original_StudentID, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_Status, string Original_Class) {
            if ((StudentID == null)) {
                throw new global::System.ArgumentNullException("StudentID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Email, global::System.Nullable<int> Status, string Class, string Original_StudentID, string Original_FullName, string Original_Email, global::System.Nullable<int> Original_Status, string Original_Class) {
            return this.Update(Original_StudentID, FullName, Email, Status, Class, Original_StudentID, Original_FullName, Original_Email, Original_Status, Original_Class);
        }
    }
